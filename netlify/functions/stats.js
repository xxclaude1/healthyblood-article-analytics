...
// ===== Dr. Gundry article scroll-section map =====
// The article fires section_view events with these string IDs. We map them to
// ordinals so the funnel math = "how far down the page did people read".
const SCREEN_ORDER = [
...
// An article has no quiz "branches" — it's a single linear read funnel.
const ALL_BRANCHES = [];
const BRANCH_KNOWN_AT = 999;  // never
...
export default async (req) => {
  ...
  out.branch_colors = {};   // no branches for an article
  // Per-section color palette (funnel bars) — 14 scroll sections.
  out.question_colors = {
    1: '#0a84ff', 2: '#34c759', 3: '#5856d6', 4: '#3b82f6',
    5: '#ef4444', 6: '#f59e0b', 7: '#10b981', 8: '#06b6d4',
    9: '#22c55e', 10: '#ec4899', 11: '#a855f7', 12: '#8b5cf6',
    13: '#f97316', 14: '#0d2137'
  };
